...
from . import export, import_, wa_import
...
def plot_wa_clusters(distance: int):
    ...
    cmap = fn.get_cmap(max_cluster_id)
...
def get_wa(
    ...
    # offset and limit
    sql_base += " ORDER BY wa_code OFFSET :offset "
    if limit == "All":
        sql_base += "LIMIT ALL "
    else:
        sql_base += "LIMIT :limit "
...
def add_genetic_data(wa_code: str):
    ...
    with fn.conn_alchemy().connect() as con:
        ...
        if request.method == "POST":
            ...
            update_loci_values_cache(wa_code, loci_list)
...
def wa_locus_note(wa_code: str, locus: str, allele: str):
    ...
    with fn.conn_alchemy().connect() as con:
        ...
        if request.method == "POST":
            ...
            update_loci_values_cache(wa_code, fn.get_loci_list())
    ...
    with fn.conn_alchemy().connect() as con:
        ...
        if request.method == "POST":
            ...
            for row in (
                ...
                update_loci_values_cache(row["wa_code"], loci_list)
